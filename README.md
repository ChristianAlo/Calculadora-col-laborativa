...
Parella 2: Implementar multiplicacio(a,b) i divisio(a,b) en mult_div.py (controlar divisió per zero). 

Parella 3: Implementar potencia(a,b) i arrel_quadrada(a) en pot_arrel.py (controlar números negatius). 

Parella 4: Implementar percentatge(base, percent) en percentatges.py. 

Parella 5: Implementar celsius_a_fahrenheit(c) i fahrenheit_a_celsius(f) en conversio.py. 
...
3. Crea una branca nova amb el teu nom o parella 
4. Implementa les funcions que et corresponen en el fitxer indicat
5. Comprova que el codi funciona
6. Fes commit dels canvis
7. Puja els canvis al teu fork
8. Ves al teu repositori en GitHub i crea una Pull Request cap al repositori original 